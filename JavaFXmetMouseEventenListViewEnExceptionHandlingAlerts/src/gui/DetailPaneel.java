...
public class DetailPaneel extends GridPane
{
        ...
        txfBedrag.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				try {
					...
					boodschap.setContentText("Invoer moet nummer zijn");
    ...
    public void update() {
    	txfRekeningNr.setText(controller.geefRekeningInfo(indexVanDeRekening)[0]);
    	txfSaldo.setText(controller.geefRekeningInfo(indexVanDeRekening)[1]);
    	txfHouder.setText(controller.geefRekeningInfo(indexVanDeRekening)[2]);
	}
