...
public class ContainerApplicatie {
    ...
    public static void main(String[] args) {
        ...
        Container nieuweContainer = new Container("Antwerpen", 60, 150, 1234);
        
        // Kijk na of de nieuwe container reeds in de lijst aanwezig is en
        // druk het resultaat af op het scherm.
        
        
       if (containers.contains(nieuweContainer)) System.out.println("Container zit al in de lijst.");
       else System.out.println("Container zit nog niet in de lijst");
    }
}